...
_Generated: 2026-09-02T17:07:56.116Z_
...
Workspace `mcp.json` _(folder: Cedys-app)_

- **c:\Users\greyes\OneDrive - Urbaser S.A\1. Comercial\Gabriel Reyes\10. Proyectos Gabriel\Cedys-app\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\greyes\.claude.json** — _File exists — no servers defined_
