    ...
    <div className="min-h-screen bg-ink pb-24 px-6 pt-6">
      ...
      <div className="flex flex-col gap-2">
        {clientes.map((u) => {
          ...
          const totalSesiones = plan?.cantidad_sesiones
            ? u.plan_sesiones_personalizado || plan.cantidad_sesiones
            : null;
                    ...
                    <div className="flex gap-2">
                      ...
                      <div className="flex-1">
                        ...
                        <input
                          ...
                          placeholder={String(plan.valor_con_iva)}
                          className="w-full bg-black/30 border border-white/10 rounded-lg px-2 py-1.5 text-white text-sm outline-none focus:border-cyan-brand transition-colors"
                        />
                      </div>
                      <div className="flex-1">
                  ...
                  >
                    ...
                    u.plan_sesiones_personalizado
                      ? `Personalizado: ${
                          ...
                          u.plan_monto_personalizado || plan.valor_con_iva
